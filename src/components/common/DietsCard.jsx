...
const DietsCard = ({ diet }) => {
    const { title, description, property_type, listing_price, gallery, property_address } = diet;
    const { full_address, street_number, street_name, city, state, zip_code } = property_address;
    console.log(gallery);
    return (
        <div>
            <div>
            ...
            <div>
                ...
                <div className="ml-[10px] flex items-center gap-x-[10px]">
                    <p className="font-normal text-[14px] text-[#111112]">1000 kcal</p>
                    <p>1000 kcal</p>
                    <p>1000 kcal</p>
                </div>
                ...
                <div className="flex items-center justify-between mt-[25px]">
                    <h1 className="font-bold text-[28px] text-[#111112] flex items-center gap-x-[5px]">
                        <sub className="font-normal text-[14px] text-[#ADAEAF]">from</sub> {listing_price}{" "}
